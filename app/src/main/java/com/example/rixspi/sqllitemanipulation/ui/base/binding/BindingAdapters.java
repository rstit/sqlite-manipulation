...
public class BindingAdapters {
    ...
    public static <U, V extends CharSequence> void applyConversion(@NonNull TextView view, @NonNull Converter<U, V> converter, @Nullable U value) {
    ...
    public static void setSelectedItem(@NonNull Spinner view, @Nullable String item) {
        ...
        String selectedItem = view.getSelectedItem().toString();
